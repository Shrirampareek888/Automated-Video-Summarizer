...
def abstractive_summary(text, minlength=50, maxlength=100):
    ...
    summary_ids = model.generate(tokenized_text, num_beams=3, no_repeat_ngram_size=1,
                                 min_length=minlength, max_length=maxlength, early_stopping=True)
    # tool = language_check.LanguageTool('en-US')
