...
def abstractive_summary(text,minlength=100,maxlength=250) -> str:
    ...
    # summmarize 
    summary_ids = model.generate(tokenized_text,num_beams=3,no_repeat_ngram_size=1,min_length=min(minlength,math.floor(0.2*len(preprocess_text))), max_length=min(maxlength,math.floor(0.5*len(preprocess_text))),early_stopping=True)
    #tool = language_check.LanguageTool('en-US')
...
def generate_pdf(extractive,abstractive):
    ...
    pdf.cell(190, 10, txt = "Thank you for choosing Smart Meet. You have been provided with a short summary of the meet as well as a more detailed", ln = 5, align = '')
    pdf.cell(190, 8, txt = "minutes of the meeting. Do provide us with your valuable suggestions regarding Smart Meet.  ", ln = 5, align = 'C')
    ...
    pdf.cell(190, 10, txt = "Short Summary of Meeting ", ln = 5, align = 'C') 
    ...
    pdf.set_font("Times","B", size = 15)
    pdf.cell(190, 10, txt = "Detailed Minutes of Meeting ", ln = 5, align = 'C')
    ...
    pdf.output("./static/minutes_of_meeting.pdf")
